...
function archi_theme_scripts_styles() {
	...
	wp_enqueue_style( 'archi-block-style', get_theme_file_uri( 'css/blocks.css' ), array( 'archi-style' ), '1.0' );
    ...
    wp_style_add_data( 'archi-theme-new-ie', 'conditional', 'gt IE 8' );
...
function archi_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'archi-block-editor-style', get_theme_file_uri( '/css/editor-blocks.css' ) );
	// Add custom fonts.
	wp_enqueue_style( 'archi-fonts', archi_fonts_url(), array(), null );
}
